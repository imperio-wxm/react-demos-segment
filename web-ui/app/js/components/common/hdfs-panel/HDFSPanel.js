...
import HDFSTopics from '../../hdfs/HDFSTopics.js'

export default class HDFSPanel extends React.Component{
    constructor(props) {
        super(props)
        this.state = {
            tablesNum: 0,
    ...
    getData = () => {
        let urls = [
            "http://localhost:8900/configInfo/get/getHDFSTopics"
        ];
    ...
    render() {
        return (
            <div style={{padding: 24, background: '#fff', minHeight: 360}}>
                <HDFSTopics tablesNum={this.state.tablesNum} tablesInfo={this.state.tablesInfo} updateConversionPanel={this.update}/>
            </div>
        );
    }
}